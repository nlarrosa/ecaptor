            ...
            <tbody>
                @foreach ($saleProducts as $saleProduct)
                    <tr>
                        ...
                        <td>
                            <div class="badge border-2 border-{{ $saleProduct->Sale->SaleStatus->color }} badge-{{ $saleProduct->Sale->SaleStatus->color }}">{{ $saleProduct->Sale->SaleStatus->name }}</div> 
                        </td>
                        <td>
                            ...
                            {{-- @if($saleProduct->SaleSketchProduct->status_sketch_id == Config::get('ecaptor.sketchStatus.id.sinenviar')) --}}
                            ...
                            <button wire:click="" class="btn btn-square btn-sm btn-error">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
