...
} elseif ($_instance->childHasBeenRendered('n6vkM9H')) {
    $componentId = $_instance->getRenderedChildComponentId('n6vkM9H');
    $componentTag = $_instance->getRenderedChildComponentTagName('n6vkM9H');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('n6vkM9H');
} else {
    $response = \Livewire\Livewire::mount('ui.alert', [ 'message' =>  $message, 'status' => 'error']);
    $html = $response->html();
    $_instance->logRenderedChild('n6vkM9H', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php unset($message);
...
<?php /**PATH C:\xampp\htdocs\grupo_hermida\ecaptor\resources\views/livewire/sketch/upload-sketch.blade.php ENDPATH**/ ?>