            ...
            <tbody>
                <?php $__currentLoopData = $saleProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saleProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <div class="badge border-2 border-<?php echo e($saleProduct->Sale->SaleStatus->color); ?> badge-<?php echo e($saleProduct->Sale->SaleStatus->color); ?>"><?php echo e($saleProduct->Sale->SaleStatus->name); ?></div> 
                        </td>
                        <td>
...
} elseif ($_instance->childHasBeenRendered('qZEKXED')) {
    $componentId = $_instance->getRenderedChildComponentId('qZEKXED');
    $componentTag = $_instance->getRenderedChildComponentTagName('qZEKXED');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qZEKXED');
} else {
    $response = \Livewire\Livewire::mount('sale.sale-detail');
    $html = $response->html();
    $_instance->logRenderedChild('qZEKXED', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('oVZX78p')) {
    $componentId = $_instance->getRenderedChildComponentId('oVZX78p');
    $componentTag = $_instance->getRenderedChildComponentTagName('oVZX78p');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oVZX78p');
} else {
    $response = \Livewire\Livewire::mount('sale.sale-detail-design');
    $html = $response->html();
    $_instance->logRenderedChild('oVZX78p', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('UCjP7Mn')) {
    $componentId = $_instance->getRenderedChildComponentId('UCjP7Mn');
    $componentTag = $_instance->getRenderedChildComponentTagName('UCjP7Mn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UCjP7Mn');
} else {
    $response = \Livewire\Livewire::mount('sketch.upload-sketch');
    $html = $response->html();
    $_instance->logRenderedChild('UCjP7Mn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
...
<?php /**PATH C:\xampp\htdocs\laravel\ecaptor\resources\views/livewire/sale/sale-list.blade.php ENDPATH**/ ?>