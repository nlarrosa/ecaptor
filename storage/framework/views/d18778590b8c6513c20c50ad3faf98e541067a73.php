...
} elseif ($_instance->childHasBeenRendered('Fd5qwfb')) {
    $componentId = $_instance->getRenderedChildComponentId('Fd5qwfb');
    $componentTag = $_instance->getRenderedChildComponentTagName('Fd5qwfb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Fd5qwfb');
} else {
    $response = \Livewire\Livewire::mount('ui.alert', ['message' => 'No tiene productos agregados al carrito.', 'status' => 'info']);
    $html = $response->html();
    $_instance->logRenderedChild('Fd5qwfb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php endif; ?>    
...
<?php /**PATH C:\xampp\htdocs\laravel\ecaptor\resources\views/livewire/cart/shopping-cart.blade.php ENDPATH**/ ?>