...
} elseif ($_instance->childHasBeenRendered('0l7Eiik')) {
    $componentId = $_instance->getRenderedChildComponentId('0l7Eiik');
    $componentTag = $_instance->getRenderedChildComponentTagName('0l7Eiik');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0l7Eiik');
} else {
    $response = \Livewire\Livewire::mount('cart.shopping-add-steps');
    $html = $response->html();
    $_instance->logRenderedChild('0l7Eiik', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>;
</div>
...
</script><?php /**PATH C:\xampp\htdocs\laravel\ecaptor\resources\views/livewire/cart/shopping-add.blade.php ENDPATH**/ ?>