...
} elseif ($_instance->childHasBeenRendered('qFDaAfr')) {
    $componentId = $_instance->getRenderedChildComponentId('qFDaAfr');
    $componentTag = $_instance->getRenderedChildComponentTagName('qFDaAfr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qFDaAfr');
} else {
    $response = \Livewire\Livewire::mount('cart.shopping-header');
    $html = $response->html();
    $_instance->logRenderedChild('qFDaAfr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php
...
} elseif ($_instance->childHasBeenRendered('37wMAtL')) {
    $componentId = $_instance->getRenderedChildComponentId('37wMAtL');
    $componentTag = $_instance->getRenderedChildComponentTagName('37wMAtL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('37wMAtL');
} else {
    $response = \Livewire\Livewire::mount('notification.header-notification');
    $html = $response->html();
    $_instance->logRenderedChild('37wMAtL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</header><?php /**PATH C:\xampp\htdocs\laravel\ecaptor\resources\views/layouts/header.blade.php ENDPATH**/ ?>